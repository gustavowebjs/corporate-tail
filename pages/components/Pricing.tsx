  ...
  return (
    <section className="bg-gray-200 dark:bg-gray-800">
      <div className="container px-6 py-8 mx-auto">
        <div className="max-w-2xl p-1.5 mx-auto overflow-hidden bg-gray-100 rounded-lg dark:bg-gray-700">
          <div className="grid gap-3 md:grid-cols-3">
            <button className="px-3 py-2 font-medium text-gray-800 uppercase transition-colors duration-200 transform bg-transparent rounded-lg focus:outline-none dark:text-gray-200 dark:hover:bg-gray-600 hover:bg-gray-200">
              Monthly
            </button>
        ...
        <div className="flex flex-col items-center justify-center mt-16 space-y-6 md:items-end md:-mx-5 md:space-y-0 md:flex-row">
          <div className="w-full px-6 py-4 transition-colors duration-200 transform rounded-lg md:mx-5 md:w-96 bg-gray-50 dark:bg-gray-700">
            <div className="text-center">
              ...
              <h4 className="mt-2 text-5xl font-semibold text-gray-800 dark:text-gray-100">
                $53.99
              </h4>
              <p className="mt-4 text-gray-500 dark:text-gray-300">
                /pre month
          ...
          <div className="w-full overflow-hidden transition-colors duration-200 transform rounded-lg md:mx-5 md:w-96 bg-gray-50 dark:bg-gray-700">
